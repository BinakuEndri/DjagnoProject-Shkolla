...
class AddStudentForm(forms.Form):
    ...
    email=forms.EmailField(label="E-mail",max_length=50,widget=forms.EmailInput(attrs={"class":"form-control","autocomplete":"off"}))
    password=forms.CharField(label="Fjalekalimi",max_length=50,widget=forms.PasswordInput(attrs={"class":"form-control"}))
    first_name=forms.CharField(label="Emri",max_length=50,widget=forms.TextInput(attrs={"class":"form-control"}))
    last_name=forms.CharField(label="Mbiemri",max_length=50,widget=forms.TextInput(attrs={"class":"form-control"}))
    ...
    course=forms.ChoiceField(label="Klasa",choices=course_list,widget=forms.Select(attrs={"class":"form-control"}))
    sex=forms.ChoiceField(label="Gjinia",choices=gender_choice,widget=forms.Select(attrs={"class":"form-control"}))
